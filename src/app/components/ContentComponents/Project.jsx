...
function ProjectGrid() {
  return (
    <div className="grid grid-cols-4 grid-rows-3 gap-2 w-full h-[300px]  -translate-y-3">
      ...
      <a href="https://www.agnihotriaerospace.com"
       target="_blank"
      ...
      <a href="https://github.com/Taurus1601/attackGAN-IDS"
       target="_blank"
       rel="noopener noreferrer">
          <motion.div
      ...
      {/* Small Project 3 - Middle Right */}
        <SpotlightCard className="rounded-[30px] col-start-3 col-span-2 bg-neutral-900/90">
      <a href="https://github.com/Taurus1601/cms-faq"
       target="_blank"
       rel="noopener noreferrer">
          <motion.div
            className="p-2 text-white"
      ...
      <a href="https://github.com/Taurus1601/educAIte"
       target="_blank"
       rel="noopener noreferrer">
        <motion.div 
          className="p-2 text-white"
      ...
      <a href="https://github.com/Taurus1601/booksage"
       target="_blank"
       rel="noopener noreferrer">
          <motion.div
            className="p-2 text-white"
